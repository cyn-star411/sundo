...
const expectedTurkey = Math.ceil(lunchTotals.totalIngredients['Turkey mince'] + dinnerTotals.totalIngredients['Turkey mince']) + ' g';
assert.ok(groceries.some((item) => item.n === 'Turkey mince' && item.q === expectedTurkey), 'cart must show the exact combined calculated turkey weight');
