...
assert.strictEqual(Math.round(expectedRaw) + ' g', groceries.find((item) => item.n === 'Turkey mince').q, 'shared turkey grocery total must equal both scheduled recipes combined');
