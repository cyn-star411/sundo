...
assert.ok(recovery.includes("location.replace('./?updated=fresh-wed-fri-plan')"), 'recovery page must return to the current app release after clearing offline state');
