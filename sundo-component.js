...
class Component extends DCLogic {
  ...
  recipes = {
    ...
    'Salted Date & Banana Chia Pots': { cuisine:'Breakfast · Inbox-inspired prep ahead', time:'10 min + overnight', kcal:430, base:2, weeklyReference:true, weeklyReferenceDays:1, fixedPlan:true, protein:50, fiber:12, slug:'salted-date-banana-chia', portions:{Cynthia:{kcal:410,protein:25},Gabriel:{kcal:460,protein:25}}, ingredients:[{n:'Greek yogurt',q:2,u:'cups',cat:'protein',prot:40},{n:'Chia seeds',q:2,u:'tbsp',cat:'carb',prot:5},{n:'Rolled oats',q:2,u:'tbsp',cat:'carb',prot:2},{n:'Bananas',q:1,u:'',cat:'veg',prot:1},{n:'Medjool dates',q:2,u:'',cat:'carb',prot:1},{n:'Milk',q:1,u:'cup',cat:'sauce',prot:6},{n:'Cashew butter',q:2,u:'tbsp',cat:'protein',prot:6},{n:'Cinnamon',q:1,u:'tsp',cat:'sauce',prot:0}], method:['This Sundō recipe uses @nourishwithrosa_\'s salted date-and-banana chia pot as its source; the app uses practical cups, spoons, and whole fruit for the two-pot prep.','Blend banana, dates, Greek yogurt, chia, oats, cinnamon, and milk until smooth. Divide into two jars.','Top each pot with cashew butter and a pinch of flaky salt, then refrigerate overnight. Add extra banana slices only when serving.'] },
    'Healthy Cinnamon Roll Protein Muffins': { cuisine:'Snack · Sundō adaptation', time:'35 min + cool', kcal:330, base:2, weeklyReference:true, weeklyReferenceDays:1, fixedPlan:true, protein:48, fiber:8, slug:'cinnamon-roll-protein-muffins', portions:{Cynthia:{kcal:300,protein:24},Gabriel:{kcal:370,protein:24}}, ingredients:[{n:'Almond flour',q:1,u:'cup',cat:'carb',prot:24},{n:'Vanilla protein powder',q:2,u:'scoops',cat:'protein',prot:48},{n:'Eggs',q:2,u:'',cat:'protein',prot:12},{n:'Greek yogurt',q:1,u:'cup',cat:'protein',prot:20},{n:'Maple syrup',q:2,u:'tbsp',cat:'sauce',prot:0},{n:'Coconut oil',q:2,u:'tbsp',cat:'sauce',prot:0},{n:'Vanilla extract',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Baking powder',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Cinnamon',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Brown sugar',q:2,u:'tbsp',cat:'sauce',prot:0}], method:['This is a clearly labelled Sundō protein adaptation of @saltnsprinkles\' Healthy Cinnamon Roll Muffins: it keeps the almond-flour cinnamon-swirl idea, with yogurt and protein powder for the plan.','Heat oven to 175°C / 350°F and line a muffin tin. Whisk almond flour, protein powder, eggs, yogurt, maple syrup, 1 tbsp coconut oil, vanilla, baking powder, and 1 tsp cinnamon.','Mix remaining coconut oil, brown sugar, and cinnamon; swirl over the batter. Bake until firm and lightly golden, then cool fully before packing.'] },
    'High-Protein Carrot Cake Squares': { cuisine:'Dessert · Inbox-inspired bake', time:'40 min + cool', kcal:250, base:2, weeklyReference:true, weeklyReferenceDays:1, fixedPlan:true, protein:34, fiber:8, slug:'protein-carrot-cake-squares', portions:{Cynthia:{kcal:220,protein:17},Gabriel:{kcal:280,protein:17}}, ingredients:[{n:'Eggs',q:2,u:'',cat:'protein',prot:12},{n:'Greek yogurt',q:1,u:'cup',cat:'protein',prot:20},{n:'Milk',q:1,u:'cup',cat:'sauce',prot:6},{n:'Rolled oats',q:2,u:'cups',cat:'carb',prot:20},{n:'Vanilla protein powder',q:2,u:'scoops',cat:'protein',prot:48},{n:'Carrots',q:2,u:'',cat:'veg',prot:2},{n:'Coconut oil',q:2,u:'tbsp',cat:'sauce',prot:0},{n:'Baking powder',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Baking soda',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Cinnamon',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Ground ginger',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Sweetener',q:2,u:'tbsp',cat:'sauce',prot:0},{n:'Light cream cheese',q:1,u:'cup',cat:'protein',prot:16}], method:['This Sundō bake is based on @raziyyz\' High-Protein Carrot Cake source, using practical whole measures for the plan. Heat oven to 175°C / 350°F and line a small square tin.','Blend oats into flour, then mix with eggs, yogurt, milk, coconut oil, protein powder, baking powder, baking soda, cinnamon, ginger, sweetener, and finely grated carrots. Bake 28–30 minutes; cool completely.','Mix cream cheese with a little sweetener and vanilla if desired, spread over the cooled cake, then cut into labelled dessert squares.'] },
    ...
    'Turkey Bean Vegetable Pasta': { cuisine:'Weeknight · Lunch', time:'25 min', kcal:590, base:2, weeklyReference:true, weeklyReferenceDays:1, fixedPlan:true, protein:70, fiber:17, slug:'turkey-bean-pasta', ingredients:[{n:'Turkey mince',q:1,u:'pack',cat:'protein',prot:66,short:'Turkey'},{n:'Wholewheat pasta',q:2,u:'cups',cat:'carb',prot:23},{n:'Cannellini beans',q:1,u:'can',cat:'protein',prot:16},{n:'Courgette',q:1,u:'',cat:'veg',prot:2},{n:'Cherry tomatoes',q:1,u:'punnet',cat:'veg',prot:3},{n:'Tomato passata',q:2,u:'cups',cat:'sauce',prot:4}], method:['Cook pasta until just tender.','Brown turkey mince, then cook courgette and tomatoes until softened.','Add passata and beans, simmer 8 minutes, then toss with pasta.'] },
    ...
    'Turkey Chilli Loaded Potatoes': { cuisine:'Comfort food · Dinner', time:'40 min', kcal:620, base:2, weeklyReference:true, weeklyReferenceDays:1, fixedPlan:true, protein:78, fiber:19, slug:'turkey-chilli-potatoes', ingredients:[{n:'Turkey mince',q:1,u:'pack',cat:'protein',prot:99,short:'Turkey'},{n:'Potatoes',q:4,u:'',cat:'carb',prot:14},{n:'Kidney beans',q:1,u:'can',cat:'protein',prot:28},{n:'Chopped tomatoes',q:1,u:'can',cat:'veg',prot:6},{n:'Red pepper',q:1,u:'',cat:'veg',prot:1},{n:'Greek yogurt',q:1,u:'cup',cat:'protein',prot:12}], method:['Bake potatoes at 210°C until tender.','Brown turkey with pepper, add beans and tomatoes, then simmer until thick.','Split potatoes and fill with chilli; top with yogurt.'] },
  ...
  prepSections = [
    {id:'breakfast',title:'Date-chia pots + cinnamon bakes',time:'35 min + chill',color:'#C8754E',steps:['Make ten salted date-and-banana chia pots: blend the chia-pot ingredients, spoon into five Cynthia and five Gabriel jars, top with cashew butter and flaky salt, then chill overnight.','Bake the cinnamon-roll protein muffins and carrot-cake squares while the chia pots chill. Cool both completely before slicing or packing so the swirls, icing, and crumb stay neat.','Pack the calculated Cynthia/Gabriel snack and dessert portions in labelled containers; add any extra banana slices only at breakfast time.']},
    {id:'mains',title:'Shared turkey prep: pasta + chilli potatoes',time:'55 min',color:'#8FB3C8',steps:['Brown one shared turkey batch for both lunch and dinner until it reaches 75°C.','Weigh and label the calculated Cynthia/Gabriel pasta and chilli allocations before adding either finish.','Finish lunch with courgette, cherry tomatoes, cannellini beans, passata and pasta; finish dinner with peppers, kidney beans, chopped tomatoes and baked potatoes.']},
  ...
  groceryFor() {
    ...
    if (!plan) {
      ...
      {h:'PROTEINS & DAIRY', items:[{n:'Turkey mince',q:q('Turkey mince','packs'),img:'gr-chicken'},{n:'Greek yogurt',q:packs('Greek yogurt',4,'large tub')},{n:'Milk',q:packs('Milk',4,'carton')},{n:'Vanilla protein powder',q:packs('Vanilla protein powder',20,'tub')},{n:'Light cream cheese',q:packs('Light cream cheese',4,'tub')},{n:'Eggs',q:q('Eggs')}]},
      {h:'PRODUCE & CARBS', items:[{n:'Bananas',q:q('Bananas')},{n:'Medjool dates',q:q('Medjool dates')},{n:'Carrots',q:q('Carrots')},{n:'Courgettes',q:q('Courgette')},{n:'Cherry tomatoes',q:q('Cherry tomatoes','punnets')},{n:'Red peppers',q:q('Red pepper')},{n:'Potatoes',q:q('Potatoes')},{n:'Rolled oats',q:packs('Rolled oats',8,'bag')},{n:'Almond flour',q:packs('Almond flour',8,'bag')},{n:'Wholewheat pasta',q:packs('Wholewheat pasta',8,'bag')},{n:'Chia seeds',q:packs('Chia seeds',16,'bag')}]},
      {h:'CUPBOARD · ONLY IF NEEDED', items:[{n:'Cannellini beans',q:q('Cannellini beans','cans')},{n:'Kidney beans',q:q('Kidney beans','cans')},{n:'Tomato passata',q:packs('Tomato passata',4,'jar')},{n:'Chopped tomatoes',q:q('Chopped tomatoes','cans')},{n:'Cashew butter',q:packs('Cashew butter',16,'jar')},{n:'Coconut oil',q:packs('Coconut oil',16,'jar')},{n:'Maple syrup',q:packs('Maple syrup',16,'bottle')},{n:'Cinnamon',q:packs('Cinnamon',16,'jar')},{n:'Vanilla extract',q:packs('Vanilla extract',16,'bottle')},{n:'Brown sugar',q:packs('Brown sugar',16,'bag')},{n:'Baking powder',q:packs('Baking powder',16,'tin')},{n:'Baking soda',q:packs('Baking soda',16,'box')},{n:'Ground ginger',q:packs('Ground ginger',16,'jar')},{n:'Sweetener',q:packs('Sweetener',16,'bag')}]},
    ]};
    }
