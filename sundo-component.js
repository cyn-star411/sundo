...
class Component extends DCLogic {
  ...
  options = {
    ...
    Dinner:['Honey Garlic Chicken & Enoki Rice Bowls','Honey Garlic Chicken & Enoki Rice Bowls','Honey Garlic Chicken & Enoki Rice Bowls'],
  };
  kcal = {'Pumpkin Chia Seed Pudding':260,'Apple & Yogurt':210,'Honey Garlic Chicken & Miso Sesame Bean Salad':560,'Honey Garlic Chicken & Enoki Rice Bowls':650};
  recipes = {
    ...
    'Honey Garlic Chicken & Miso Sesame Bean Salad': { cuisine:'Asian-inspired · Lunch', time:'15 min with prep', kcal:560, base:2, fixedPlan:true, protein:54, fiber:17, slug:'honey-garlic-chicken-bean-salad', portions:{Cynthia:{kcal:500,protein:24},Gabriel:{kcal:650,protein:30}}, ingredients:[{n:'Honey garlic chicken thighs',q:300,u:'g',cat:'protein',prot:48,short:'Chicken'},{n:'Chickpeas, drained',q:80,u:'g',cat:'protein',prot:7},{n:'Shelled edamame',q:50,u:'g',cat:'protein',prot:6},{n:'Snap peas',q:35,u:'g',cat:'veg',prot:1},{n:'Purple cabbage, shredded',q:50,u:'g',cat:'veg',prot:1},{n:'Green onions',q:1,u:'',cat:'veg',prot:0},{n:'White miso',q:1,u:'tbsp',cat:'sauce',prot:2},{n:'Soy sauce',q:2,u:'tsp',cat:'sauce',prot:1},{n:'Rice vinegar',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Toasted sesame oil',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Lime',q:0.5,u:'',cat:'sauce',prot:0},{n:'Sesame seeds',q:2,u:'tsp',cat:'sauce',prot:1},{n:'Honey',q:0.5,u:'tsp',cat:'sauce',prot:0},{n:'Red pepper flakes',q:0.5,u:'tsp',cat:'sauce',prot:0}], method:['Reheat 300 g prepped honey garlic chicken until piping hot; keep it separate while the salad stays cold and crisp.','Toss chickpeas, edamame, snap peas, cabbage and green onions with white miso, soy sauce, rice vinegar, lime juice, sesame oil, honey, red pepper flakes and sesame seeds.','Divide the salad into two containers and top with chicken just before eating. Cynthia takes the smaller chicken portion; Gabriel takes the larger chicken portion and any extra edamame.'] },
    'Honey Garlic Chicken & Enoki Rice Bowls': { cuisine:'Asian-inspired · Dinner', time:'10 min with prep', kcal:650, base:2, fixedPlan:true, protein:55, fiber:10, slug:'honey-garlic-chicken-rice-bowl', portions:{Cynthia:{kcal:560,protein:24},Gabriel:{kcal:760,protein:31}}, ingredients:[{n:'Honey garlic chicken thighs',q:300,u:'g',cat:'protein',prot:48,short:'Chicken'},{n:'Cooked jasmine rice',q:420,u:'g',cat:'carb',prot:12,short:'Rice'},{n:'Shelled edamame',q:100,u:'g',cat:'protein',prot:12},{n:'Enoki mushrooms',q:200,u:'g',cat:'veg',prot:5,short:'Enoki'},{n:'Purple cabbage, shredded',q:150,u:'g',cat:'veg',prot:2},{n:'Carrots, ribboned',q:100,u:'g',cat:'veg',prot:1},{n:'Green onions',q:2,u:'',cat:'veg',prot:0},{n:'Lime',q:0.5,u:'',cat:'sauce',prot:0},{n:'Sesame seeds',q:2,u:'tsp',cat:'sauce',prot:1}], method:['Trim the root end from 200 g enoki mushrooms, separate the clusters, then cook them in a hot non-stick pan for 3–4 minutes until tender and steaming; do not eat them raw.','Reheat 300 g prepped honey garlic chicken and 420 g cooked jasmine rice until piping hot.','Build bowls with rice, cooked enoki, edamame, cabbage, carrot ribbons and green onions; add the chicken on top. Use a 1:2 rice split: Cynthia gets about 140 g cooked rice and Gabriel gets about 280 g. Finish both bowls with lime and sesame seeds.'] },
  ...
  recipeOrder = ['Pumpkin Chia Seed Pudding','Apple & Yogurt','Honey Garlic Chicken & Miso Sesame Bean Salad','Honey Garlic Chicken & Enoki Rice Bowls'];
  resolveRecipe(name) {
  ...
  timeline = [{t:'0:00',l:'Chia jars'},{t:'0:15',l:'Chicken thighs'},{t:'0:35',l:'Bean salad'},{t:'0:55',l:'Rice bowls'},{t:'1:15',l:'Done'}];
  prepSections = [
    ...
    {id:'mains',title:'Honey garlic chicken, bean salad & rice',time:'60 min',color:'#8FB3C8',steps:['Mix 1.8 kg chicken thighs with 2 tbsp soy sauce, 2 tbsp dark soy sauce, 2 tbsp oyster sauce, 4 tsp garlic powder, 4 tbsp honey and 2 tbsp sriracha. Air-fry in batches at 190°C / 375°F for 12–15 minutes, until the thickest thigh reaches 75°C.','Cool promptly, then label 12 portions: six for Wednesday–Friday lunches and six for Wednesday–Friday dinners. Keep each lunch portion with the salad separate until serving.','Make one full miso sesame bean salad batch for the six lunch servings. Cook rice for the three dinners, cool it quickly, and pack with edamame, cabbage, carrot and green onion. Keep 600 g leftover enoki mushrooms dry and refrigerated; cook 200 g fresh for each dinner bowl pair.']},
    {id:'veg',title:'One shared crunchy vegetable prep',time:'20 min',color:'#7C8A5E',steps:['Shred purple cabbage, ribbon carrots, trim snap peas and slice green onions. Keep cabbage dry in one large container.','Mix the bean-salad dressing separately; toss the lunch salad only on prep day or the night before so it stays crunchy.','Keep limes and sesame seeds ready for the rice bowls.']},
    {id:'store',title:'Storage guide',time:'5 min',color:'#382C24',steps:['Refrigerate all meals for the remaining 3 days. Cool cooked chicken and rice promptly; keep cold food cold.','Reheat chicken and rice until steaming and at least 75°C; keep the bean salad, apple toppings and fresh lime cold until serving.','If Friday will run late, freeze its chicken portions now and thaw them overnight in the refrigerator on Thursday.']},
  ];
  ...
  dishSrc(name) {
    ...
    const planPhotos = {
      ...
      'Honey Garlic Chicken & Enoki Rice Bowls':'chicken-satay',
    };
  ...
  groceryFor() {
    ...
    if (!plan) return { label:'Wednesday–Friday Meal Prep', skipped:[], groups:[
      {h:'PROTEINS & DAIRY', items:[{n:'Chicken thighs',q:'1.8 kg',img:'gr-chicken'},{n:'Plain non-fat Greek yogurt',q:'500 g'},{n:'Milk of choice',q:'1 L'}]},
      {h:'PRODUCE & CARBS', items:[{n:'Apples',q:'6'},{n:'Enoki mushrooms',q:'600 g leftover / use what you have'},{n:'Purple cabbage',q:'1 small head'},{n:'Carrots',q:'500 g'},{n:'Snap peas',q:'300 g'},{n:'Green onions',q:'2 bunches'},{n:'Limes',q:'4'},{n:'Short-grain or jasmine rice',q:'1 kg'}]},
      {h:'CUPBOARD · ONLY IF NEEDED', items:[{n:'Pumpkin purée',q:'1 × 425 g tin'},{n:'Chia seeds',q:'250 g'},{n:'Pumpkin pie spice',q:'1 jar'},{n:'Pumpkin seeds',q:'100 g'},{n:'Maple syrup',q:'1 small bottle'},{n:'Chickpeas',q:'1 × 400 g tin'},{n:'Shelled edamame',q:'600 g'},{n:'White miso',q:'1 small tub'},{n:'Soy sauce',q:'only if needed'},{n:'Dark soy sauce',q:'only if needed'},{n:'Oyster sauce',q:'only if needed'},{n:'Rice vinegar',q:'only if needed'},{n:'Toasted sesame oil',q:'only if needed'},{n:'Sesame seeds',q:'only if needed'},{n:'Honey',q:'only if needed'},{n:'Sriracha',q:'only if needed'},{n:'Garlic powder',q:'only if needed'},{n:'Red pepper flakes',q:'only if needed'}]},
    ]};
  ...
  ingredientsPanel() {
    ...
    const row = (ing,i) => {
      ...
      return e('div',{key:i,style:{display:'flex',alignItems:'center',padding:'9px 4px',borderBottom:'1px solid '+C.line}},
        ...
        e('span',{style:{flex:1,textAlign:'right',fontFamily:"'Hanken Grotesk',sans-serif",fontSize:13.5,fontWeight:600,color:C.sumi}},fmt(perServing*sTot)+(ing.u?' '+ing.u:'')),
    ...
    return e('div',{style:{padding:'18px 24px 8px'}},
      ...
      e('div',{style:{display:'flex',padding:'0 4px 8px',fontFamily:"'JetBrains Mono',monospace",fontSize:10,letterSpacing:'.06em',color:C.mut}},
        e('span',{style:{flex:2}},'INGREDIENT'), e('span',{style:{flex:1,textAlign:'right'}},'TOTAL TO COOK')),
      catMeta.map(cat=>{
