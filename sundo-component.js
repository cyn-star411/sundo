...
class Component extends DCLogic {
  ...
  options = {
    Breakfast:['Pumpkin Protein Overnight Oats','Pumpkin Protein Overnight Oats','Pumpkin Protein Overnight Oats'],
    Snack:['Cottage Cheese Protein Balls','Cottage Cheese Protein Balls','Cottage Cheese Protein Balls'],
    Lunch:['Beef Bulgogi Bibimbap','Beef Bulgogi Bibimbap','Beef Bulgogi Bibimbap'],
    Dinner:['Ginger Beef, Mushroom & Spinach Rice Soup','Ginger Beef, Mushroom & Spinach Rice Soup','Ginger Beef, Mushroom & Spinach Rice Soup'],
  };
  kcal = {'Pumpkin Protein Overnight Oats':430,'Cottage Cheese Protein Balls':260,'Beef Bulgogi Bibimbap':590,'Ginger Beef, Mushroom & Spinach Rice Soup':520};
  recipes = {
  ...
  recipeOrder = ['Pumpkin Protein Overnight Oats','Cottage Cheese Protein Balls','Beef Bulgogi Bibimbap','Ginger Beef, Mushroom & Spinach Rice Soup'];
  resolveRecipe(name) {
  ...
  dishSrc(name) {
    ...
    const planPhotos = {
      ...
      'Ginger Beef, Mushroom & Spinach Rice Soup':'beef-bibimbap',
    };
  ...
  groceryFor() {
    ...
    if (!plan) {
      ...
      {h:'PROTEINS & DAIRY', items:[{n:'Lean beef mince',q:q('Lean beef mince, raw'),img:'gr-chicken'},{n:'Greek yogurt',q:'1 kg'},{n:'Cottage cheese',q:'750 g'},{n:'Milk of choice',q:'1 L'},{n:'Eggs',q:'6'}]},
      {h:'PRODUCE & CARBS', items:[{n:'Mushrooms',q:q('Mushrooms')},{n:'Spinach',q:q('Spinach')},{n:'Carrots',q:q('Carrots')},{n:'Bean sprouts',q:Math.round(lunch.totalIngredients['Bean sprouts'])+' g'},{n:'Spring onions',q:'2 bunches'},{n:'Yellow onions',q:'2'},{n:'Garlic',q:'2 bulbs'},{n:'Fresh ginger',q:'60 g'},{n:'Apples',q:'6'},{n:'Jasmine rice',q:q('Jasmine rice, dry')},{n:'Rolled oats',q:'500 g'}]},
      {h:'CUPBOARD · ONLY IF NEEDED', items:[{n:'Pumpkin purée',q:'1 × 425 g tin'},{n:'Pumpkin pie spice',q:'1 jar'},{n:'Maple syrup',q:'1 small bottle'},{n:'Vanilla extract',q:'1 small bottle'},{n:'Almond flour',q:'200 g'},{n:'Oat flour',q:'150 g'},{n:'Almond butter',q:'1 small jar'},{n:'Dark chocolate chips',q:'300 g'},{n:'Coconut oil',q:'1 small jar'},{n:'Soy sauce',q:'only if needed'},{n:'Oyster sauce',q:'only if needed'},{n:'Rice vinegar',q:'only if needed'},{n:'Toasted sesame oil',q:'only if needed'},{n:'Honey',q:'only if needed'},{n:'Gochujang',q:'1 small tub'},{n:'Beef stock',q:'2 L'}]},
    ]};
    }
