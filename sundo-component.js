...
class Component extends DCLogic {
  ...
  timeline = [{t:'0:00',l:'Rice on'},{t:'0:20',l:'Press tofu'},{t:'0:40',l:'Boil eggs'},{t:'0:55',l:'Sauces'},{t:'1:20',l:'Prep veg'},{t:'1:40',l:'Berries'},{t:'2:00',l:'Done'}];
  prepSections = [
    {id:'salmon',title:'Salmon prep',time:'10 min',color:'#CB9C8B',steps:['Defrost in the fridge from the morning (8+ hrs). Never at room temperature.','Pat each portion completely dry before cooking — the key to a good sear.','Cook fresh each day; keeps raw 2 days. Do not bulk pre-cook.']},
    {id:'tofu',title:'Tofu prep — all 4 days',time:'25 min',color:'#C8754E',steps:['Slice both blocks into slabs and press all at once, 20 min under a weight.','Cut into 2cm cubes; divide into 4 day containers.','Refrigerate uncovered overnight — air-drying makes them crispier.','Coat in cornstarch only just before cooking, never in advance.']},
    {id:'rice',title:'Rice — both types',time:'30 min',color:'#7C8A5E',steps:['Jasmine: rinse 3×, 1:1.2 water, boil then lowest heat 12 min, rest 5.','Brown: rinse 2×, 1:2 water, simmer 25 min, rest 10.','Leave Thursday jasmine uncovered overnight — day-old rice is key for bibimbap.','Portion into labelled containers; fridge up to 4 days.']},
    {id:'eggs',title:'Eggs & sauces',time:'25 min',color:'#8FB3C8',steps:['Hard-boil 6 eggs: cold start, 10 min boil, 2 min cold bath. Store unpeeled.','Miso glaze (jar 1): miso + soy + honey + sesame oil + vinegar.','Ginger soy (jar 2): soy + sesame + honey + vinegar + garlic + ginger.','Honey garlic (jar 3): honey + soy + garlic + sesame oil + lemon.']},
    {id:'veg',title:'Vegetables & produce',time:'20 min',color:'#9A8A76',steps:['Cucumber into rounds; store with paper towel, keeps 4 days.','Spring onions trimmed & sliced into a jar; pak choi rinsed, kept whole.','Broccoli into florets, sealed bag — cook fresh each time.','Move one bag of berries to the fridge to defrost for Tuesday.']},
    {id:'store',title:'Storage guide',time:'5 min',color:'#382C24',steps:['Label every container: name + day.','Fridge top: 3 sauce jars + raw salmon, kept separate.','Middle: tofu, boiled eggs, rice. Bottom: greens & cucumber.','Counter: avocados & bananas. Freeze a banana for Wednesday.']},
  ];

  state = { dayFilter:'all', selected:null, swapOpen:false, cooked:{}, week:null, segTab:'ingredients', swipeIdx:0, servings:2, openSection:'salmon', prepDone:{}, currentRecipe:'Miso Salmon Bowl', recipeGlow:false,
    people: {
