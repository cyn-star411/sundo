...
class Component extends DCLogic {
  ...
  recipes = {
    ...
    'Chicken Larb Tahini Noodles': { cuisine:'Thai · Lunch', time:'15 min', kcal:525, base:2, protein:54, fiber:7, slug:'chicken-larb-tahini-noodles',
      ...
      method:['Cook noodles to the packet instructions, then drain and rinse briefly so they stay springy.','Shred the cabbage and ribbon the carrot — use the same veg prep box you made for the rice bowls.','Whisk tahini, soy, rice vinegar, sesame oil and a splash of warm water into a glossy dressing.','Toss noodles and vegetables through the dressing. Reheat the larb until piping hot, then spoon it over.','Finish with spring onion. Keep the noodle base and larb separate until serving for the best texture.'] },
    ...
    'Chicken Larb Cabbage Cups': { cuisine:'Thai · Light meal', time:'10 min', kcal:430, base:2, protein:50, fiber:7, slug:'chicken-larb-cabbage-cups',
      ...
      method:['Peel away the larger cabbage leaves and slice the remaining cabbage, cucumber and carrot for a crunchy shared salad.','Reheat the larb until piping hot and loosen with a squeeze of lime if needed.','Spoon larb into the cabbage leaves with the shredded vegetables.','Serve with rice alongside and finish with the reserved toasted rice powder for crunch.'] },
    'Sticky Beef Mince Bulk Prep': { cuisine:'Thai-inspired · Bulk prep', time:'45 min', kcal:450, base:10, protein:250, fiber:2, slug:'sticky-beef-bulk-prep',
      ...
      method:['Cook the beef mince in three batches over high heat, leaving each batch undisturbed until crisp at the edges.','Stir together garlic, spring onions, chillies, oyster sauce, soy, sriracha and rice vinegar.','Return all the beef to the pan, add the sauce and reduce until glossy and sticky.','Cool promptly, then portion into ten 160 g servings. Refrigerate up to 3 days; freeze the Thursday and Friday portions on prep day.'] },
    'Sticky Beef Mince Brothy Rice': { cuisine:'Thai-inspired · Dinner', time:'15 min', kcal:510, base:2, protein:58, fiber:5, slug:'sticky-beef-brothy-rice',
      ingredients:[{n:'Prepared sticky beef mince',q:320,u:'g',cat:'protein',prot:50,short:'Beef'},{n:'Jasmine rice, dry',q:140,u:'g',cat:'carb',prot:10,short:'Rice'},{n:'Beef stock',q:700,u:'ml',cat:'sauce',prot:5},{n:'Ginger',q:20,u:'g',cat:'sauce',prot:0},{n:'Fresh coriander',q:15,u:'g',cat:'veg',prot:1},{n:'Red chilli',q:1,u:'',cat:'veg',prot:0},{n:'Lime',q:1,u:'',cat:'sauce',prot:0}],
      method:['Cook the rice. Simmer stock with bashed ginger for 10 min.','Reheat the prepared sticky beef mince in a hot pan until piping hot.','Season the broth with lime juice and a little fish sauce to taste.','Divide rice between bowls, ladle over broth and top with sticky beef, coriander and chilli.'] },
    'Sticky Beef Mince Crunchy Rice Bowl': { cuisine:'Thai-inspired · Lunch', time:'12 min', kcal:500, base:2, protein:54, fiber:6, slug:'sticky-beef-crunchy-rice-bowl',
      ...
      method:['Reheat the sticky beef and rice until steaming hot.','Use the same cabbage, carrot and cucumber prep box as the larb rice bowls.','Build bowls with rice, sticky beef and the crunchy vegetables.','Finish with lime; add a little fish sauce or sriracha only if needed.'] },
  ...
  renderDiscover() {
    const C=this.C, st=this.state;
    const rail=['Japanese','Korean','Thai'];
    const cuisineDishes={
