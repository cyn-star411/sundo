...
class Component extends DCLogic {
  ...
  days = [{k:'Thu',sub:'Quick prep'},{k:'Fri',sub:'Finish strong'}];
  slotColor = { Breakfast:'#7C8A5E', Snack:'#8FB3C8', Lunch:'#CB9C8B', Dinner:'#C8754E', Dessert:'#9B7E9B' };
  // Two actual prep days: each slot is one four-portion batch for Thursday and Friday.
  options = {
    Breakfast:Array(2).fill('Salted Date & Banana Chia Pots'),
    Snack:Array(2).fill('Healthy Cinnamon Roll Protein Muffins'),
    Lunch:Array(2).fill('Turkey Bean Vegetable Pasta'),
    Dinner:Array(2).fill('Turkey Chilli Loaded Potatoes'),
    Dessert:Array(2).fill('High-Protein Carrot Cake Squares'),
  };
  ...
  // The current window is Thursday–Friday. These quantities are four portions total,
  ...
  prepSections = [
    {id:'breakfast',title:'One Thursday–Friday breakfast + bake session',time:'40 min + chill',color:'#C8754E',steps:['Make four salted date-and-banana chia pots: blend the batch ingredients, spoon into two Cynthia and two Gabriel jars, top with cashew butter and flaky salt, then chill overnight.','Bake one four-muffin batch of cinnamon-roll protein muffins and one four-square batch of carrot-cake squares while the chia pots chill. The carrot cake uses 2 eggs. Cool both completely before slicing or packing.','Pack the calculated Cynthia/Gabriel snack and dessert portions in labelled containers; add any extra banana slices only at breakfast time.']},
    {id:'mains',title:'One shared Thursday–Friday turkey prep',time:'50 min',color:'#8FB3C8',steps:['Brown one shared turkey batch of 1.1 kg, in two wide batches, until it reaches 75°C; reserve 600 g for pasta and 500 g for chilli.','Weigh and label the calculated Cynthia/Gabriel pasta and chilli allocations before adding either finish.','Finish lunch with courgette, cherry tomatoes, cannellini beans, passata and pasta; finish dinner with peppers, kidney beans, chopped tomatoes and baked potatoes.']},
    ...
    {id:'store',title:'Two-day storage guide',time:'5 min',color:'#382C24',steps:['Refrigerate all Thursday–Friday portions promptly; nothing needs freezing for this two-day window.','Reheat turkey pasta and turkey chilli until steaming and at least 75°C; add yogurt just before serving.','Keep chia pots and baked snack/dessert portions chilled; pack muffins and carrot-cake squares airtight.']},
  ];
  ...
  groceryFor() {
    ...
    if (!plan) {
      ...
      return { label:'Thursday–Friday Meal Prep', skipped:[], groups:[
