...
class Component extends DCLogic {
  ...
  // A fresh, intentional rest-of-week prep for Cynthia and Gabriel. Lunch and dinner share turkey and tomato/bean pantry staples, not last week's meals.
  options = {
    Breakfast:Array(5).fill('Berry Protein Overnight Oats'),
    Snack:Array(5).fill('Banana Protein Yogurt'),
    Lunch:Array(5).fill('Turkey Bean Vegetable Pasta'),
    Dinner:Array(5).fill('Turkey Chilli Loaded Potatoes'),
    Dessert:Array(5).fill('Cottage Cheese Berry Cup'),
  };
  kcal = {'Berry Protein Overnight Oats':450,'Banana Protein Yogurt':260,'Turkey Bean Vegetable Pasta':590,'Turkey Chilli Loaded Potatoes':620,'Cottage Cheese Berry Cup':240};
  recipes = {
  ...
  recipeOrder = ['Berry Protein Overnight Oats','Banana Protein Yogurt','Turkey Bean Vegetable Pasta','Turkey Chilli Loaded Potatoes','Cottage Cheese Berry Cup'];
  resolveRecipe(name) {
  ...
  timeline = [{t:'0:00',l:'Berry overnight oats'},{t:'0:15',l:'Yogurt snacks + berry cups'},{t:'0:30',l:'Shared turkey batch'},{t:'0:55',l:'Pasta + chilli potatoes'},{t:'1:25',l:'Done'}];
  prepSections = [
    {id:'breakfast',title:'Berry oats + yogurt pots',time:'25 min + chill',color:'#C8754E',steps:['Make ten berry protein overnight oats: stir oats, chia, protein powder and milk, fold through berries, then chill in five Cynthia and five Gabriel jars.','Pack ten banana protein-yogurt snacks; keep the peanut butter swirled in and slice bananas just before eating if preferred.','Prep ten cottage-cheese berry cups; keep pumpkin seeds separate until serving so they stay crunchy.']},
  ...
  dishSrc(name) {
    ...
    const planPhotos = {
      'Berry Protein Overnight Oats':'mango-oats', 'Banana Protein Yogurt':'banana-smoothie',
      'Turkey Bean Vegetable Pasta':'chicken-cabbage-carrot-stir-fry',
      'Turkey Chilli Loaded Potatoes':'katsu-curry', 'Cottage Cheese Berry Cup':'matcha-yogurt',
    };
  ...
  groceryFor() {
    ...
    if (!plan) {
      ...
      {h:'PROTEINS & DAIRY', items:[{n:'Turkey mince',q:q('Turkey mince','packs'),img:'gr-chicken'},{n:'Greek yogurt',q:packs('Greek yogurt',4,'large tub')},{n:'Cottage cheese',q:packs('Cottage cheese',4,'large tub')},{n:'Milk',q:packs('Milk',4,'carton')},{n:'Protein powder',q:packs('Protein powder',20,'tub')}]},
      {h:'PRODUCE & CARBS', items:[{n:'Bananas',q:q('Bananas')},{n:'Mixed berries',q:packs('Mixed berries',5,'bag')},{n:'Courgettes',q:q('Courgette')},{n:'Cherry tomatoes',q:q('Cherry tomatoes','punnets')},{n:'Red peppers',q:q('Red pepper')},{n:'Potatoes',q:q('Potatoes')},{n:'Rolled oats',q:packs('Rolled oats',8,'bag')},{n:'Wholewheat pasta',q:packs('Wholewheat pasta',8,'bag')},{n:'Chia seeds',q:packs('Chia seeds',16,'bag')},{n:'Pumpkin seeds',q:packs('Pumpkin seeds',16,'bag')}]},
      {h:'CUPBOARD · ONLY IF NEEDED', items:[{n:'Cannellini beans',q:q('Cannellini beans','cans')},{n:'Kidney beans',q:q('Kidney beans','cans')},{n:'Tomato passata',q:packs('Tomato passata',4,'jar')},{n:'Chopped tomatoes',q:q('Chopped tomatoes','cans')},{n:'Peanut butter',q:packs('Peanut butter',16,'jar')}]},
    ]};
    }
