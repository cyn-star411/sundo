...
class Component extends DCLogic {
  ...
  recipes = {
    ...
    'Honey Garlic Chicken & Miso Sesame Bean Salad': { cuisine:'Asian-inspired · Lunch', time:'15 min with prep', kcal:560, base:2, fixedPlan:true, protein:54, fiber:17, slug:'honey-garlic-chicken-bean-salad', portions:{Cynthia:{kcal:500,protein:24},Gabriel:{kcal:650,protein:30}}, ingredients:[{n:'Chicken thighs, raw',q:300,u:'g',cat:'protein',prot:48,short:'Chicken'},{n:'Soy sauce (chicken)',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Dark soy sauce',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Oyster sauce',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Garlic powder',q:0.67,u:'tsp',cat:'sauce',prot:0},{n:'Honey (chicken)',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Sriracha',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Chickpeas, drained',q:80,u:'g',cat:'protein',prot:7},{n:'Shelled edamame',q:50,u:'g',cat:'protein',prot:6},{n:'Snap peas',q:35,u:'g',cat:'veg',prot:1},{n:'Purple cabbage, shredded',q:50,u:'g',cat:'veg',prot:1},{n:'Green onions',q:1,u:'',cat:'veg',prot:0},{n:'White miso',q:1,u:'tbsp',cat:'sauce',prot:2},{n:'Soy sauce (salad)',q:2,u:'tsp',cat:'sauce',prot:1},{n:'Rice vinegar',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Toasted sesame oil',q:1,u:'tsp',cat:'sauce',prot:0},{n:'Lime',q:0.5,u:'',cat:'sauce',prot:0},{n:'Sesame seeds',q:2,u:'tsp',cat:'sauce',prot:1},{n:'Honey (salad)',q:0.5,u:'tsp',cat:'sauce',prot:0},{n:'Red pepper flakes',q:0.5,u:'tsp',cat:'sauce',prot:0}], method:['This card is one two-person lunch: its 300 g chicken amount is raw. The weekly Prep ritual makes this exact recipe 3× at once — 900 g raw chicken total — for six lunch containers.','For one recipe, toss the chicken with soy sauce, dark soy, oyster sauce, garlic powder, honey and sriracha. Air-fry at 190°C / 375°F for 12–15 minutes, until the thickest piece reaches 75°C.','Toss chickpeas, edamame, snap peas, cabbage and green onions with white miso, salad soy sauce, rice vinegar, lime juice, sesame oil, honey, red pepper flakes and sesame seeds.','Divide the chicken and cold salad into two containers. Cynthia takes the smaller chicken portion; Gabriel takes the larger chicken portion and any extra edamame. Reheat only the chicken until steaming; keep the salad cold and crisp.'] },
