...
class Component extends DCLogic {
  ...
  options = {
    ...
    Dinner:['Honey Garlic Chicken Rice Bowls','Honey Garlic Chicken Rice Bowls','Honey Garlic Chicken Rice Bowls'],
  };
  kcal = {'Pumpkin Chia Seed Pudding':260,'Apple & Yogurt':210,'Honey Garlic Chicken & Miso Sesame Bean Salad':560,'Honey Garlic Chicken Rice Bowls':650};
  recipes = {
    ...
    'Honey Garlic Chicken Rice Bowls': { cuisine:'Asian-inspired · Dinner', time:'10 min with prep', kcal:650, base:2, fixedPlan:true, protein:55, fiber:10, slug:'honey-garlic-chicken-rice-bowl', portions:{Cynthia:{kcal:560,protein:24},Gabriel:{kcal:760,protein:31}}, ingredients:[{n:'Honey garlic chicken thighs',q:300,u:'g',cat:'protein',prot:48,short:'Chicken'},{n:'Cooked jasmine rice',q:420,u:'g',cat:'carb',prot:12,short:'Rice'},{n:'Shelled edamame',q:100,u:'g',cat:'protein',prot:12},{n:'Purple cabbage, shredded',q:150,u:'g',cat:'veg',prot:2},{n:'Carrots, ribboned',q:100,u:'g',cat:'veg',prot:1},{n:'Green onions',q:2,u:'',cat:'veg',prot:0},{n:'Lime',q:0.5,u:'',cat:'sauce',prot:0},{n:'Sesame seeds',q:2,u:'tsp',cat:'sauce',prot:1}], method:['Reheat 300 g prepped honey garlic chicken and 420 g cooked jasmine rice until piping hot.','Build bowls with rice, edamame, cabbage, carrot ribbons and green onions; add the chicken on top.','Use a 1:2 rice split: Cynthia gets about 140 g cooked rice and Gabriel gets about 280 g. Finish both bowls with lime and sesame seeds.'] },
  ...
  recipeOrder = ['Pumpkin Chia Seed Pudding','Apple & Yogurt','Honey Garlic Chicken & Miso Sesame Bean Salad','Honey Garlic Chicken Rice Bowls'];
  resolveRecipe(name) {
  ...
  dishSrc(name) {
    ...
    const planPhotos = {
      ...
      'Honey Garlic Chicken Rice Bowls':'chicken-satay',
    };
  ...
  groceryFor() {
    ...
    if (!plan) return { label:'Wednesday–Friday Meal Prep', skipped:[], groups:[
      ...
      {h:'PRODUCE & CARBS', items:[{n:'Apples',q:'6'},{n:'Purple cabbage',q:'1 small head'},{n:'Carrots',q:'500 g'},{n:'Snap peas',q:'300 g'},{n:'Green onions',q:'2 bunches'},{n:'Limes',q:'4'},{n:'Short-grain or jasmine rice',q:'1 kg'}]},
