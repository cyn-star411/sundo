...
class Component extends DCLogic {
  ...
  prepSections = [
    ...
    {id:'mains',title:'Batch-cook chicken & shared bases',time:'55 min',color:'#8FB3C8',steps:['Heat the oven to 200°C. Spread 2.6 kg chicken thighs or breast in a single layer across two trays; season only with salt, pepper and a little oil so each meal can take its own flavours later. Roast until the thickest pieces reach 75°C, about 18–25 minutes depending on size; rest 10 minutes before slicing.','Label five cooled portions: 1.2 kg as three 400 g portions for Monday, Tuesday and Wednesday lemon-parsley bowls; 600 g for Thursday chicken-chickpea traybake; and 800 g for Friday fajita bowls. Refrigerate the three lunch portions in the refrigerator; freeze the Thursday and Friday portions immediately, then thaw overnight in the refrigerator before use.','Cook brown rice and lentils for the chicken bowls, curry and fajita bowls. Brown turkey mince for the pasta sauce and chilli; cool portions quickly before refrigerating.']},
