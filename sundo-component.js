...
class Component extends DCLogic {
  ...
  // Short, intentional rest-of-week prep for Cynthia and Gabriel. This uses the selected inbox recipes and shared low-waste ingredients.
  options = {
    Breakfast:Array(5).fill('Pumpkin Protein Overnight Oats'),
    Snack:Array(5).fill('Cottage Cheese Protein Balls'),
    Lunch:Array(5).fill('Beef Bulgogi Bibimbap'),
    Dinner:Array(5).fill('Ginger Beef, Mushroom & Spinach Rice Soup'),
    Dessert:Array(5).fill('Matcha Yogurt Cup'),
  };
  kcal = {'Pumpkin Protein Overnight Oats':430,'Cottage Cheese Protein Balls':260,'Beef Bulgogi Bibimbap':590,'Ginger Beef, Mushroom & Spinach Rice Soup':520,'Matcha Yogurt Cup':210};
  recipes = {
  ...
  recipeOrder = ['Pumpkin Protein Overnight Oats','Cottage Cheese Protein Balls','Beef Bulgogi Bibimbap','Ginger Beef, Mushroom & Spinach Rice Soup','Matcha Yogurt Cup'];
  resolveRecipe(name) {
  ...
  timeline = [{t:'0:00',l:'Overnight oats'},{t:'0:20',l:'Protein balls'},{t:'0:45',l:'Bulgogi bowls'},{t:'1:10',l:'Ginger rice soup'},{t:'1:30',l:'Done'}];
  prepSections = [
    {id:'breakfast',title:'Pumpkin overnight oats + protein balls',time:'45 min + chill',color:'#C8754E',steps:['Make ten pumpkin protein overnight oats: whisk the pumpkin mixture, fold in Greek yogurt and oats, then divide into ten jars. Keep diced apple separate until breakfast.','Make 30 cottage cheese protein balls, chill them, then pack ten labelled three-ball snacks. Keep the chocolate-coated balls refrigerated.','Prep five matcha yogurt desserts; keep granola separate so it stays crisp. Label each breakfast, snack and dessert for Cynthia or Gabriel.']},
    {id:'mains',title:'Shared beef prep: bibimbap + rice soup',time:'70 min',color:'#8FB3C8',steps:['Cook one shared neutral beef batch for both lunch and dinner.','Portion the shared neutral beef batch into labelled Cynthia/Gabriel lunch and dinner allocations before adding either recipe’s flavours.','Finish each labelled allocation with its own bibimbap or rice-soup aromatics and sauce, then refrigerate Wednesday/Thursday and freeze Friday–Sunday portions.']},
    ...
    {id:'store',title:'Storage guide',time:'5 min',color:'#382C24',steps:['Refrigerate Wednesday and Thursday meals promptly. Freeze Friday–Sunday lunch and dinner portions on prep day.','Reheat beef and soup until steaming and at least 75°C; add gochujang, spring onions and apple toppings just before serving.','Thaw the next day’s frozen portion overnight in the refrigerator. Keep overnight oats, protein balls and matcha yogurt chilled.']},
  ];
  ...
  dishSrc(name) {
    ...
    const planPhotos = {
      'Pumpkin Protein Overnight Oats':'mango-oats', 'Cottage Cheese Protein Balls':'rice-cakes-pb',
      'Beef Bulgogi Bibimbap':'beef-bibimbap',
      'Ginger Beef, Mushroom & Spinach Rice Soup':'beef-bibimbap', 'Matcha Yogurt Cup':'matcha-yogurt',
    };
  ...
  groceryFor() {
    ...
    if (!plan) {
      const lunch=this.weeklyRecipeTotals(this.recipes['Beef Bulgogi Bibimbap']);
      const dinner=this.weeklyRecipeTotals(this.recipes['Ginger Beef, Mushroom & Spinach Rice Soup']);
      const q=(name)=>Math.round((lunch.totalIngredients[name]||0)+(dinner.totalIngredients[name]||0))+' g';
      return { label:'Wednesday–Sunday Meal Prep', skipped:[], groups:[
      {h:'PROTEINS & DAIRY', items:[{n:'Lean beef mince',q:q('Lean beef mince, raw'),img:'gr-chicken'},{n:'Greek yogurt',q:'2.35 kg'},{n:'Cottage cheese',q:'1.2 kg'},{n:'Milk of choice',q:'1.5 L'},{n:'Eggs',q:'6'}]},
      {h:'PRODUCE & CARBS', items:[{n:'Mushrooms',q:q('Mushrooms')},{n:'Spinach',q:q('Spinach')},{n:'Carrots',q:q('Carrots')},{n:'Bean sprouts',q:Math.round(lunch.totalIngredients['Bean sprouts'])+' g'},{n:'Spring onions',q:'2 bunches'},{n:'Yellow onions',q:'2'},{n:'Garlic',q:'2 bulbs'},{n:'Fresh ginger',q:'35 g'},{n:'Apples',q:'10'},{n:'Jasmine rice',q:q('Jasmine rice, dry')},{n:'Rolled oats',q:'700 g'},{n:'Mixed berries',q:'250 g'},{n:'Granola',q:'1 small bag'}]},
      {h:'CUPBOARD · ONLY IF NEEDED', items:[{n:'Pumpkin purée',q:'2 × 425 g tins'},{n:'Pumpkin pie spice',q:'1 jar'},{n:'Maple syrup',q:'1 small bottle'},{n:'Vanilla extract',q:'1 small bottle'},{n:'Almond flour',q:'300 g'},{n:'Oat flour',q:'200 g'},{n:'Almond butter',q:'1 small jar'},{n:'Dark chocolate chips',q:'500 g'},{n:'Coconut oil',q:'1 small jar'},{n:'Matcha powder',q:'1 small tin'},{n:'Soy sauce',q:'only if needed'},{n:'Oyster sauce',q:'only if needed'},{n:'Rice vinegar',q:'only if needed'},{n:'Toasted sesame oil',q:'only if needed'},{n:'Honey',q:'1 small bottle'},{n:'Gochujang',q:'1 small tub'},{n:'Beef stock',q:'1.5 L'}]},
    ]};
    }
