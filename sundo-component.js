...
class Component extends DCLogic {
  ...
  days = [{k:'Wed',sub:'Start fresh'},{k:'Thu',sub:'Midweek fuel'},{k:'Fri',sub:'Finish strong'},{k:'Sat',sub:'Weekend reset'},{k:'Sun',sub:'Sunday wind-down'}];
  slotColor = { Breakfast:'#7C8A5E', Snack:'#8FB3C8', Lunch:'#CB9C8B', Dinner:'#C8754E', Dessert:'#9B7E9B' };
  // A fresh, intentional rest-of-week prep for Cynthia and Gabriel. Lunch and dinner share turkey and tomato/bean pantry staples; breakfast, snack, and dessert have real flavour and texture.
  options = {
    Breakfast:Array(5).fill('Salted Date & Banana Chia Pots'),
    Snack:Array(5).fill('Healthy Cinnamon Roll Protein Muffins'),
    Lunch:Array(5).fill('Turkey Bean Vegetable Pasta'),
    Dinner:Array(5).fill('Turkey Chilli Loaded Potatoes'),
    Dessert:Array(5).fill('High-Protein Carrot Cake Squares'),
  };
  ...
  recipes = {
    ...
    'Cottage Cheese Berry Cup': { cuisine:'Snack', time:'3 min', kcal:240, base:2, weeklyReference:true, weeklyReferenceDays:1, fixedPlan:true, protein:34, fiber:7, slug:'cottage-cheese-berries', ingredients:[{n:'Cottage cheese',q:2,u:'cups',cat:'protein',prot:48},{n:'Mixed berries',q:2,u:'cups',cat:'veg',prot:3},{n:'Pumpkin seeds',q:3,u:'tbsp',cat:'protein',prot:9}], method:['Divide cottage cheese and berries between two pots.','Scatter with pumpkin seeds just before eating.'] },
    'Banana Protein Yogurt': { cuisine:'Snack', time:'3 min', kcal:260, base:2, weeklyReference:true, weeklyReferenceDays:1, fixedPlan:true, protein:34, fiber:6, slug:'banana-protein-yogurt', ingredients:[{n:'Greek yogurt',q:2,u:'cups',cat:'protein',prot:35},{n:'Bananas',q:2,u:'',cat:'veg',prot:2},{n:'Peanut butter',q:2,u:'tbsp',cat:'protein',prot:8}], method:['Slice bananas over the yogurt.','Swirl through peanut butter and divide between two pots.'] },
    'Salted Date & Banana Chia Pots': { cuisine:'Breakfast · Five-day batch', time:'15 min + overnight', kcal:430, base:10, weeklyReference:true, weeklyReferenceDays:5, batchPrep:true, batchReferenceProtein:64, fixedPlan:true, protein:50, fiber:12, slug:'salted-date-banana-chia', portions:{Cynthia:{kcal:410,protein:25},Gabriel:{kcal:460,protein:25}}, ingredients:[{n:'Greek yogurt',q:10,u:'cups',cat:'protein',prot:40},{n:'Chia seeds',q:10,u:'tbsp',cat:'carb',prot:5},{n:'Rolled oats',q:10,u:'tbsp',cat:'carb',prot:2},{n:'Bananas',q:5,u:'',cat:'veg',prot:1},{n:'Medjool dates',q:10,u:'',cat:'carb',prot:1},{n:'Milk',q:5,u:'cups',cat:'sauce',prot:6},{n:'Cashew butter',q:10,u:'tbsp',cat:'protein',prot:6},{n:'Cinnamon',q:5,u:'tsp',cat:'sauce',prot:0}], method:['This Sundō recipe uses @nourishwithrosa_\'s salted date-and-banana chia pot as its source; these are the complete five-day batch quantities for ten jars.','Blend banana, dates, Greek yogurt, chia, oats, cinnamon, and milk until smooth. Divide between ten labelled jars.','Top each pot with cashew butter and a pinch of flaky salt, then refrigerate overnight. Add extra banana slices only when serving.'] },
    'Healthy Cinnamon Roll Protein Muffins': { cuisine:'Snack · Five-day Sundō batch', time:'35 min + cool', kcal:330, base:10, weeklyReference:true, weeklyReferenceDays:5, batchPrep:true, batchReferenceProtein:64, fixedPlan:true, protein:48, fiber:8, slug:'cinnamon-roll-protein-muffins', portions:{Cynthia:{kcal:300,protein:24},Gabriel:{kcal:370,protein:24}}, ingredients:[{n:'Almond flour',q:2,u:'cups',cat:'carb',prot:24},{n:'Vanilla protein powder',q:4,u:'scoops',cat:'protein',prot:48},{n:'Eggs',q:4,u:'',cat:'protein',prot:12},{n:'Greek yogurt',q:2,u:'cups',cat:'protein',prot:20},{n:'Maple syrup',q:4,u:'tbsp',cat:'sauce',prot:0},{n:'Coconut oil',q:4,u:'tbsp',cat:'sauce',prot:0},{n:'Vanilla extract',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Baking powder',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Cinnamon',q:4,u:'tsp',cat:'sauce',prot:0},{n:'Brown sugar',q:4,u:'tbsp',cat:'sauce',prot:0}], method:['This is a clearly labelled Sundō protein adaptation of @saltnsprinkles\' Healthy Cinnamon Roll Muffins: one bake makes ten snack muffins.','Heat oven to 175°C / 350°F and line a 12-hole muffin tin. Whisk almond flour, protein powder, eggs, yogurt, maple syrup, 2 tbsp coconut oil, vanilla, baking powder, and 2 tsp cinnamon.','Mix remaining coconut oil, brown sugar, and cinnamon; swirl over the batter. Bake until firm and lightly golden, then cool fully before packing one labelled muffin per snack.'] },
    'High-Protein Carrot Cake Squares': { cuisine:'Dessert · Five-day batch', time:'40 min + cool', kcal:250, base:10, weeklyReference:true, weeklyReferenceDays:5, batchPrep:true, batchReferenceProtein:64, fixedPlan:true, protein:34, fiber:8, slug:'protein-carrot-cake-squares', portions:{Cynthia:{kcal:220,protein:17},Gabriel:{kcal:280,protein:17}}, ingredients:[{n:'Eggs',q:4,u:'',cat:'protein',prot:12},{n:'Greek yogurt',q:2,u:'cups',cat:'protein',prot:20},{n:'Milk',q:2,u:'cups',cat:'sauce',prot:6},{n:'Rolled oats',q:4,u:'cups',cat:'carb',prot:20},{n:'Vanilla protein powder',q:4,u:'scoops',cat:'protein',prot:48},{n:'Carrots',q:4,u:'',cat:'veg',prot:2},{n:'Coconut oil',q:4,u:'tbsp',cat:'sauce',prot:0},{n:'Baking powder',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Baking soda',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Cinnamon',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Ground ginger',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Sweetener',q:4,u:'tbsp',cat:'sauce',prot:0},{n:'Light cream cheese',q:2,u:'cups',cat:'protein',prot:16}], method:['This Sundō bake is based on @raziyyz\' High-Protein Carrot Cake source, using practical whole measures for one ten-square batch. Heat oven to 175°C / 350°F and line a 20 cm / 8 inch square tin.','Blend oats into flour, then mix with 4 eggs, yogurt, milk, coconut oil, protein powder, baking powder, baking soda, cinnamon, ginger, sweetener, and finely grated carrots. Bake 28–30 minutes; cool completely.','Mix cream cheese with a little sweetener and vanilla if desired, spread over the cooled cake, then cut into ten labelled dessert squares.'] },
    ...
    'Turkey Bean Vegetable Pasta': { cuisine:'Weeknight · Five-day lunch batch', time:'45 min', kcal:590, base:10, weeklyReference:true, weeklyReferenceDays:5, batchPrep:true, batchReferenceProtein:64, fixedPlan:true, protein:70, fiber:17, slug:'turkey-bean-pasta', ingredients:[{n:'Turkey mince',q:1500,u:'g',cat:'protein',prot:66,short:'Turkey'},{n:'Wholewheat pasta',q:10,u:'cups',cat:'carb',prot:23},{n:'Cannellini beans',q:5,u:'cans',cat:'protein',prot:16},{n:'Courgette',q:5,u:'',cat:'veg',prot:2},{n:'Cherry tomatoes',q:5,u:'punnets',cat:'veg',prot:3},{n:'Tomato passata',q:10,u:'cups',cat:'sauce',prot:4}], method:['Cook pasta until just tender.','Brown the 1.5 kg turkey mince, then cook courgette and tomatoes until softened.','Add passata and beans, simmer 8 minutes, then toss with pasta. Cool quickly and divide into ten labelled lunch portions.'] },
    ...
    'Turkey Chilli Loaded Potatoes': { cuisine:'Comfort food · Five-day dinner batch', time:'55 min', kcal:620, base:10, weeklyReference:true, weeklyReferenceDays:5, batchPrep:true, batchReferenceProtein:64, fixedPlan:true, protein:78, fiber:19, slug:'turkey-chilli-potatoes', ingredients:[{n:'Turkey mince',q:1250,u:'g',cat:'protein',prot:99,short:'Turkey'},{n:'Potatoes',q:20,u:'',cat:'carb',prot:14},{n:'Kidney beans',q:5,u:'cans',cat:'protein',prot:28},{n:'Chopped tomatoes',q:5,u:'cans',cat:'veg',prot:6},{n:'Red pepper',q:5,u:'',cat:'veg',prot:1},{n:'Greek yogurt',q:5,u:'cups',cat:'protein',prot:12}], method:['Bake potatoes at 210°C until tender.','Brown the 1.25 kg turkey with pepper, add beans and tomatoes, then simmer until thick.','Split potatoes and fill with chilli; top with yogurt. Cool and label ten dinner portions; freeze Friday–Sunday portions on prep day.'] },
    ...
    'Pumpkin Protein Overnight Oats': { cuisine:'Breakfast · Inbox-inspired prep ahead', time:'10 min + overnight', kcal:430, base:10, fixedPlan:true, protein:180, fiber:90, slug:'mango-oats', portions:{Cynthia:{kcal:390,protein:16},Gabriel:{kcal:500,protein:22}}, ingredients:[{n:'Milk of choice',q:1500,u:'ml',cat:'sauce',prot:45},{n:'Pumpkin purée',q:700,u:'g',cat:'veg',prot:8},{n:'Plain non-fat Greek yogurt',q:1500,u:'g',cat:'protein',prot:150},{n:'Rolled oats',q:700,u:'g',cat:'carb',prot:83},{n:'Maple syrup',q:100,u:'ml',cat:'sauce',prot:0},{n:'Pumpkin pie spice',q:3.5,u:'tsp',cat:'sauce',prot:0},{n:'Vanilla extract',q:2,u:'tsp',cat:'sauce',prot:0},{n:'Apples',q:10,u:'',cat:'veg',prot:0}], method:['This Sundō adaptation uses the inbox pumpkin-oats ingredients, with extra Greek yogurt for a more filling breakfast. Whisk milk, pumpkin purée, maple syrup, pumpkin pie spice and vanilla until smooth.','Fold in the Greek yogurt and oats. Divide evenly between ten lidded jars, then refrigerate overnight.','Top each jar with diced apple just before breakfast. Label five jars for Cynthia and five for Gabriel; keep apples separate until serving.'] },
    'Cottage Cheese Protein Balls': { cuisine:'Snack · Inbox-inspired batch', time:'25 min + chill', kcal:260, base:10, fixedPlan:true, protein:140, fiber:30, slug:'rice-cakes-pb', portions:{Cynthia:{kcal:230,protein:12},Gabriel:{kcal:300,protein:16}}, ingredients:[{n:'Cottage cheese',q:1200,u:'g',cat:'protein',prot:143},{n:'Honey',q:300,u:'ml',cat:'sauce',prot:0},{n:'Almond flour',q:300,u:'g',cat:'carb',prot:63},{n:'Oat flour',q:200,u:'g',cat:'carb',prot:27},{n:'Almond butter',q:225,u:'g',cat:'protein',prot:47},{n:'Vanilla extract',q:5,u:'tsp',cat:'sauce',prot:0},{n:'Dark chocolate chips',q:500,u:'g',cat:'sauce',prot:30},{n:'Coconut oil',q:75,u:'g',cat:'sauce',prot:0}], method:['This is a five-day Sundō adaptation of the inbox recipe: blend cottage cheese, honey, almond butter and vanilla until smooth.','Fold in almond flour and oat flour. Roll into 30 equal balls, then refrigerate for 15 minutes to firm.','Melt the chocolate chips with coconut oil, dip the balls, then chill for 1 hour. Pack ten labelled three-ball snack portions.'] },
    'Beef Bulgogi Bibimbap': { cuisine:'Korean-inspired · Weekly lunch prep', time:'50 min', kcal:590, base:6, portionProtein:30, weeklyReference:true, weeklyReferenceDays:3, planKind:'bulgogi', fixedPlan:true, protein:264, fiber:36, slug:'beef-bibimbap', portions:{Cynthia:{kcal:560,protein:30},Gabriel:{kcal:650,protein:34}}, ingredients:[{n:'Lean beef mince, raw',q:900,u:'g',cat:'protein',prot:189,short:'Beef'},{n:'Mushrooms',q:225,u:'g',cat:'veg',prot:7},{n:'Yellow onion',q:1,u:'',cat:'veg',prot:1},{n:'Garlic',q:5,u:'cloves',cat:'sauce',prot:0},{n:'Soy sauce',q:4,u:'tbsp',cat:'sauce',prot:4},{n:'Oyster sauce',q:1,u:'tbsp',cat:'sauce',prot:1},{n:'Honey',q:2,u:'tbsp',cat:'sauce',prot:0},{n:'Toasted sesame oil',q:1,u:'tbsp',cat:'sauce',prot:0},{n:'Jasmine rice, dry',q:360,u:'g',cat:'carb',prot:26},{n:'Carrots',q:450,u:'g',cat:'veg',prot:4},{n:'Spinach',q:450,u:'g',cat:'veg',prot:14},{n:'Bean sprouts',q:300,u:'g',cat:'veg',prot:9},{n:'Eggs',q:6,u:'',cat:'protein',prot:36},{n:'Spring onions',q:2,u:'',cat:'veg',prot:1},{n:'Gochujang',q:6,u:'tbsp',cat:'sauce',prot:6},{n:'Rice vinegar',q:2,u:'tbsp',cat:'sauce',prot:0}], method:['This Sundō adaptation is based on the ingredient list and six-bowl yield in the inbox. Cook rice; set aside.','Brown the beef and finely chopped mushrooms with onion and garlic. Add soy sauce, oyster sauce, honey and sesame oil; cook until glossy and the beef reaches 75°C.','Sauté carrots, wilt spinach and blanch bean sprouts separately. Divide rice, vegetables and beef between containers; add a cooked egg and gochujang only when serving.'] },
    'Ginger Beef, Mushroom & Spinach Rice Soup': { cuisine:'Asian-inspired · Weekly dinner prep', time:'35 min', kcal:520, base:6, portionProtein:26, weeklyReference:true, weeklyReferenceDays:3, planKind:'riceSoup', fixedPlan:true, protein:240, fiber:24, slug:'sticky-beef-ginger-rice-soup', portions:{Cynthia:{kcal:490,protein:30},Gabriel:{kcal:590,protein:34}}, ingredients:[{n:'Lean beef mince, raw',q:750,u:'g',cat:'protein',prot:158,short:'Beef'},{n:'Mushrooms',q:450,u:'g',cat:'veg',prot:14},{n:'Spinach',q:450,u:'g',cat:'veg',prot:14},{n:'Yellow onion',q:1,u:'',cat:'veg',prot:1},{n:'Garlic',q:4,u:'cloves',cat:'sauce',prot:0},{n:'Fresh ginger',q:45,u:'g',cat:'sauce',prot:0},{n:'Beef stock',q:1800,u:'ml',cat:'sauce',prot:12},{n:'Jasmine rice, dry',q:300,u:'g',cat:'carb',prot:21},{n:'Soy sauce',q:3,u:'tbsp',cat:'sauce',prot:3},{n:'Rice vinegar',q:2,u:'tbsp',cat:'sauce',prot:0},{n:'Spring onions',q:4,u:'',cat:'veg',prot:1}], method:['This is a practical Sundō shared-ingredient dinner, built from the beef, mushroom, spinach, rice, garlic, ginger, soy and spring onion ingredients in the inbox. Cook the rice separately.','Brown the beef with onion, garlic and half the ginger until it reaches 75°C. Add mushrooms, stock, soy sauce and rice vinegar; simmer 10 minutes.','Stir in spinach to wilt. Divide rice into bowls, ladle over the soup and finish with spring onions and the remaining ginger.'] },
  ...
  timeline = [{t:'0:00',l:'Date-banana chia pots'},{t:'0:15',l:'Cinnamon muffins + carrot cake squares'},{t:'0:35',l:'Shared turkey batch'},{t:'1:00',l:'Pasta + chilli potatoes'},{t:'1:30',l:'Done'}];
  prepSections = [
    {id:'breakfast',title:'One breakfast + bake session',time:'45 min + chill',color:'#C8754E',steps:['Make ten salted date-and-banana chia pots: blend the batch ingredients, spoon into five Cynthia and five Gabriel jars, top with cashew butter and flaky salt, then chill overnight.','Bake one ten-muffin batch of cinnamon-roll protein muffins and one ten-square batch of carrot-cake squares while the chia pots chill. The carrot cake uses 4 eggs — not a separate bake every day. Cool both completely before slicing or packing so the swirls, icing, and crumb stay neat.','Pack the calculated Cynthia/Gabriel snack and dessert portions in labelled containers; add any extra banana slices only at breakfast time.']},
    {id:'mains',title:'One shared turkey prep: pasta + chilli',time:'55 min',color:'#8FB3C8',steps:['Brown one shared turkey batch of 2.75 kg, in two wide batches, until it reaches 75°C; reserve 1.5 kg for pasta and 1.25 kg for chilli.','Weigh and label the calculated Cynthia/Gabriel pasta and chilli allocations before adding either finish.','Finish lunch with courgette, cherry tomatoes, cannellini beans, passata and pasta; finish dinner with peppers, kidney beans, chopped tomatoes and baked potatoes.']},
    {id:'veg',title:'One tomato, bean & vegetable prep',time:'25 min',color:'#7C8A5E',steps:['Rinse and drain the cannellini and kidney beans; halve cherry tomatoes, dice courgette and slice red peppers.','Batch-roast the potatoes until tender while the turkey browns. Cool cooked pasta promptly before boxing lunches.','The shared turkey, canned beans and tomato base keep the shop smaller while the pasta and chilli stay genuinely different meals.']},
    {id:'store',title:'Storage guide',time:'5 min',color:'#382C24',steps:['Refrigerate Wednesday and Thursday meals promptly. Freeze Friday–Sunday lunch and dinner portions on prep day.','Reheat turkey pasta and turkey chilli until steaming and at least 75°C; add yogurt just before serving.','Thaw the next day’s frozen portion overnight in the refrigerator. Keep chia pots and baked snack/dessert portions chilled; pack muffins and carrot-cake squares airtight.']},
  ];
  ...
  weeklyRecipeTotals(recipe) {
    ...
    // A five-day bake or pot is one finished batch, not five separate two-person recipes.
    // Its size still follows saved profiles; the batch is simply divided across its actual ten portions.
    if (recipe.batchPrep) {
      const totalTarget=people.reduce((sum,[,person])=>sum+this.mealProteinTarget(person),0);
      const batchScale=totalTarget/(recipe.batchReferenceProtein||totalTarget);
      people.forEach(([label,person])=>{
        const share=this.mealProteinTarget(person)/totalTarget, ingredients={};
        recipe.ingredients.forEach(ing=>{ ingredients[ing.n]=ing.q*batchScale*share/occurrences; });
        out[label]={protein:this.mealProteinTarget(person),scale:batchScale*share,ingredients};
      });
      recipe.ingredients.forEach(ing=>{
        out.totalIngredients[ing.n]=ing.q*batchScale;
      });
      return out;
    }
    people.forEach(([label,person])=>{
      const scale=this.portionScaleFor(recipe,person), divisor=(recipe.base||2)*(recipe.weeklyReference?(recipe.weeklyReferenceDays||3):1), ingredients={};
      ...
      gr.items.forEach(it=>{
        ...
        out.push(e('div',{key:gr.h+it.n,style:{display:'flex',alignItems:'center',gap:9,padding:'8px 0',borderBottom:'1px solid rgba(56,44,36,.08)',opacity:have?.55:1}},
          e('button',{onClick:()=>{ if(have) return; this.setState({groceryTicks:{...ticks,[it.n]:!on}}); },style:{flex:1,minWidth:0,border:'none',cursor:have?'default':'pointer',background:'transparent',textAlign:'left',display:'flex',alignItems:'center',gap:11,padding:0}},
            ...
            e('span',{style:{flex:1,minWidth:0,fontFamily:"'Hanken Grotesk',sans-serif",fontSize:14,color:(on||have)?'rgba(56,44,36,.45)':'#382C24',textDecoration:(on&&!have)?'line-through':'none',whiteSpace:'normal',overflow:'visible',textOverflow:'clip',lineHeight:1.25}},it.n),
    ...
    return e('div',{style:{height:'100%',display:'flex',flexDirection:'column'}},
      ...
      e('div',{key:'stats',style:{flex:'0 0 auto',margin:'18px 22px 0',display:'flex',gap:10}},
        e('div',{style:{flex:1,background:C.peri,borderRadius:18,padding:'16px 14px',textAlign:'center'}},
          e('div',{style:{fontFamily:"'Newsreader',serif",fontSize:27,color:C.sumi}},cookedCount,e('span',{style:{fontSize:14,color:'#6B5D50'}},'/'+(this.days.length*this.slots.length))),
      ...
      e('div',{key:'cta',style:{flex:'0 0 auto',padding:'12px 22px 26px'}},
        ...
        e('div',{style:{fontFamily:"'Hanken Grotesk',sans-serif",fontSize:11,color:'#9a8a76',textAlign:'center',marginTop:8}},ratedCount+' of '+this.recipeOrder.length+' rated · ratings teach next week')));
  }
  renderWeekPreview() {
  ...
  ingredientsPanel() {
    ...
    // Use rounded-up household units throughout: no scale, no fractional produce, no mystery decimals.
    const unitLabel = (n, unit) => {
      const forms={cup:['cup','cups'],cups:['cup','cups'],scoop:['scoop','scoops'],scoops:['scoop','scoops'],pack:['pack','packs'],can:['can','cans'],punnet:['punnet','punnets']};
      const pair=forms[unit];
      return pair ? pair[n===1?0:1] : unit;
    };
    const fmtIngredient = (v, unit)=>{ const n=Math.max(1,Math.ceil(v)); return n+(unit?' '+unitLabel(n,unit):' whole'); };
    // per-person macro split: food grams per category + nutrient protein total
    const split = (person)=>{
      const scale=this.personPortionScale(person), divisor=(r.base||2)*(r.weeklyReference?(r.weeklyReferenceDays||3):1);
    ...
    const mainItems = ['protein','carb','veg'].map(cat=>{
      const gItems = r.ingredients.filter(ing=>ing.cat===cat);
      if(!gItems.length) return null;
      return gItems.reduce((a,b)=>b.q>a.q?b:a);
    }).filter(Boolean);
    const portionAmount = (ing, scale) => { const n=Math.max(1,Math.ceil(ing.q/((r.base||2)*(r.weeklyReference?(r.weeklyReferenceDays||3):1))*scale)); return n+(ing.u?' '+unitLabel(n,ing.u):' whole'); };
    const personHead = (p, scale, sp) => e('div',{key:p.name,style:{flex:1,background:p===me?'#F6ECE1':'#F3EBDD',borderRadius:14,padding:'12px 12px'}},
      ...
      e('div',{style:{display:'flex',flexDirection:'column',gap:4}},
        mainItems.map(ing=>e('div',{key:ing.n,style:{display:'flex',justifyContent:'space-between',fontFamily:"'Hanken Grotesk',sans-serif",fontSize:12,color:'#57493C'}},
          ...
          e('span',{style:{fontFamily:"'JetBrains Mono',monospace",fontSize:11}},portionAmount(ing,scale)))),
    ...
    return e('div',{style:{height:'100%',minHeight:0,display:'flex',flexDirection:'column'}},
      ...
      e('div',{key:'h',style:{flex:'0 0 auto',padding:'14px 24px 0'}},
        e('div',{style:{display:'flex',justifyContent:'space-between',alignItems:'flex-start'}},
          e('div',null,
            e('div',{style:{fontFamily:"'JetBrains Mono',monospace",fontSize:10,letterSpacing:'.12em',color:C.mut}},'WED–SUN · REST-OF-WEEK PREP'),
      ...
      e('div',{key:'sec',style:{flex:1,minHeight:0,overflowY:'auto',WebkitOverflowScrolling:'touch',overscrollBehavior:'contain',padding:'16px 24px calc(116px + env(safe-area-inset-bottom, 0px))',display:'flex',flexDirection:'column',gap:10}},
