...
class Component extends DCLogic {
  ...
  prepSections = [
    ...
    {id:'mains',title:'Honey garlic chicken, bean salad & tofu soba',time:'60 min',color:'#8FB3C8',steps:['Mix 900 g chicken thighs with 1 tbsp soy sauce, 1 tbsp dark soy sauce, 1 tbsp oyster sauce, 2 tsp garlic powder, 2 tbsp honey and 1 tbsp sriracha. Air-fry at 190°C / 375°F for 12–15 minutes, until the thickest thigh reaches 75°C.','Cool promptly, then label 6 lunch portions for Wednesday–Friday. Keep each chicken portion separate from the bean salad until serving.','Make one full miso sesame bean salad batch for the six lunch servings. Press and cube 900 g tofu; keep it chilled until you pan-sear each dinner. Keep 600 g leftover enoki mushrooms dry and refrigerated; cook 200 g fresh for each tofu-and-enoki soba dinner pair.']},
