...
class Component extends DCLogic {
  ...
  recipes = {
    ...
    'Turkey Bean Vegetable Pasta': { cuisine:'Weeknight · Lunch', time:'25 min', kcal:590, base:2, weeklyReference:true, weeklyReferenceDays:5, fixedPlan:true, protein:70, fiber:17, slug:'turkey-bean-pasta', ingredients:[{n:'Turkey mince',q:300,u:'g',cat:'protein',prot:66,short:'Turkey'},{n:'Wholewheat pasta',q:180,u:'g',cat:'carb',prot:23},{n:'Cannellini beans',q:240,u:'g',cat:'protein',prot:16},{n:'Courgette',q:1,u:'',cat:'veg',prot:2},{n:'Cherry tomatoes',q:250,u:'g',cat:'veg',prot:3},{n:'Tomato passata',q:300,u:'g',cat:'sauce',prot:4}], method:['Cook pasta until just tender.','Brown turkey mince, then cook courgette and tomatoes until softened.','Add passata and beans, simmer 8 minutes, then toss with pasta.'] },
